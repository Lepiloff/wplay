...
#TODO можно ли прочекать @database.transaction()  выполнился успешно, например для возвращения True или False в accept_invite что бы прикрепит сообщение о результате выполнения запроса
